...
class BinanceClient:
    def __init__(self):
        ...
        # 3. Configuración de Proxy (Vital)
    ...
    def get_account_status(self):
        """Intenta obtener balance con log de errores detallado"""
        if not self.client: return {"equity": 0.0, "unrealized_pnl": 0.0, "error": "No hay cliente"}
        try:
