...
class BinanceClient:
    ...
    def get_price(self, symbol="BTCUSDT"):
        """Estrategia de respaldo múltiple para evitar el 0.00 en Railway."""
        sources = [
    ...
    def get_account_status(self):
        """Obtiene el estado de cuenta: Wallet, PNL flotante y Equity."""
    ...
    def registrar_trade(self, side, entry, exit, pnl):
        """Guarda el trade en el CSV. Nota: En Railway se borra al reiniciar."""
        ...
        with open(archivo, "a", newline='') as f:
            ...
            writer.writerow([datetime.now().strftime("%Y-%m-%d %H:%M:%S"), side, entry, exit, round(pnl, 4)])
